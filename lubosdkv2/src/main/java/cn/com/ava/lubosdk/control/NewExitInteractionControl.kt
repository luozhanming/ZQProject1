...
class NewExitInteractionControl(
    ...
    override fun getControlParams(): LinkedHashMap<String, String> {
        return linkedMapOf<String, String>().apply {
            ...
            this["command"] = "1"
            this["data"] =
                    EncryptUtil.bytes2HexString("confCtrl_exit".toByteArray()).toLowerCase()
        }
    }
    ...
    override fun build(response: String): Boolean {
        ...
        return "confCtrl_exit_ret=ok"==response
    }
}
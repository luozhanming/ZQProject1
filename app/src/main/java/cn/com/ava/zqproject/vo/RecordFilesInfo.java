...
import cn.com.ava.zqproject.usb.RecordFileDLStateEvent;

public class RecordFilesInfo {
    ...
    public static class RecordFile implements Serializable {
        ...
        public static final int STATE_IDLE = 2001;
        public static final int STATE_DOWNLOADING = 2002;
        public static final int STATE_HAS_DOWNLOADED = 2003;
        public static final int STATE_ON_DOWNLOAD_QUEUE = 2004;

        @IntDef({STATE_IDLE, STATE_DOWNLOADING, STATE_HAS_DOWNLOADED,STATE_ON_DOWNLOAD_QUEUE})
        ...
        public void setState(@RecordFileDLStateEvent.State int state) {
            this.state = state;
        }
